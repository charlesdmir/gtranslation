...
<html>
    ...
    <body>
        ...
        <div id="show-translation" class="content scaffold-show" role="main">
            ...
            <f:display bean="translation" />
            <g:form resource="${this.translation}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.translation}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
