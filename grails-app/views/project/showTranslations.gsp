...
<ol class="breadcrumb">
    ...
    <li><g:link class="list" action="index"><g:message code="default.list.label" args="['Project']"/></g:link></li>
    <li><g:link class="list" action="show" params="[id: category.project.id]">${category.project.name}</g:link></li>
    <li class="active"><g:message code="default.list.label" args="['Translate']"/></li>
</ol>

<h1>${com.gTranslation.util.CategoryUtil.getCategoryNameWithLocale(category)}</h1>
...
<div class="row">
    <div class="col-md-6">
        ...
        <table id="table"
               data-url="/translation/list?category.id=${category?.id}"
